...
import com.dyb.socket.client.component.CharsetByteRelative;
import com.dyb.socket.client.sender.BFileSender;
import com.dyb.socket.client.sender.DefaultSender;
import com.dyb.socket.client.sender.FileSender;
import com.dyb.socket.client.sender.GetFileSender;
import com.dyb.socket.client.sender.MessageSender;
...
public class Commons {
	...
	"\t\t2、 传送文本文件，例如：\"sendFile /home/dyb/a.sql charset=utf-8\"\n" +
	"\t\t3、 传送非文本文件，例如：\"sendBFile /home/dyb/aaa.jpg\"\n" +
	...
	private final static List<CharsetByteRelative> CHARSET_BYTE_LIST = Arrays.asList(
	...
	public static byte getCharsetByteByName(String charset){
		for(CharsetByteRelative charsetByteRelative : CHARSET_BYTE_LIST){
